...
- Во директории lesson6 расположен Vagrantfile с образом Centos 7 и автоматизированными шагами установки скрипта в Cron + установка почтового сервера postfix для отправки писем
